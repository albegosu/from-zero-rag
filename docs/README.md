...
Technical documentation for hypar.
...
- [`concepts/embryo.md`](concepts/embryo.md) — the Embryo unit of knowledge
- [`concepts/lifecycle.md`](concepts/lifecycle.md) — lifecycle states
- [`concepts/agent.md`](concepts/agent.md) — agent as collaborator
- [`concepts/fossils.md`](concepts/fossils.md) — fossils and memory
